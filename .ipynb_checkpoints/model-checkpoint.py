"""Contains PyTorch model code to instantiate a TinyVGG model from the CNN Exaplainer website."""
import torch
...
class TinyVGG(nn.Module):
    ...
    def forward(self, x:torch.Tensor):
        ...
        x = self.classifier(x)
        return x
        #return self.classifier(self.conv_block_2(self.conv_block_1(x))) #this can also be done it leverages the benefits of operator fusion                                        
